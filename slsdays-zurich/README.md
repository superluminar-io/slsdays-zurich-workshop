...
This is a sample template for slsdays-zurich - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name slsdays-zurich --query 'Stacks[].Outputs'
```
